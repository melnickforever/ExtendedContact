...
class Edit extends \Dmelnyk\ExtendedContact\Controller\Adminhtml\Contact
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register(\Dmelnyk\ExtendedContact\Model\Contact::EXTENDED_CONTACT, $model);
